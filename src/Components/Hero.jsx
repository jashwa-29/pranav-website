...
const Hero = () => {
    return (
        ...
        <section class="relative bg-hero-pattern bg-no-repeat bg-center w-[100%] h-[100vh] bg-cover flex items-center justify-center">
            {/* Container */}
            <div className="mx-auto w-full max-w-7xl px-4 py-16 md:px-10 md:py-20">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <a
                        href="#"
                        className=" inline-block items-center rounded-[50px] bg-transparent border-[2px] border-white px-8 py-4 text-center font-semibold text-white "
                    >
