    ...
    <div>
      <section className="lg:w-11/12 w-full mx-auto  font-jakarta flex flex-col lg:flex-row lg:items-center justify-between py-10 lg:py-20 lg:px-8 px-4">
        <div className=" px-4 lg:px-0 text-center lg:text-left">
          <p className="text-[#636262] text-[16px] lg:text-[20px] py-3 lg:py-5 tracking-[0.4px]">
            GET TO KNOW US
          </p>
          ...
          <button className="w-[150px] md:w-[194px] h-[50px] md:h-[70px] rounded-[130px] gap-10 border-2 border-black text-[16px] md:text-[18px] leading-[18px] font-[700]">
            Discover More
          </button>
        </div>
